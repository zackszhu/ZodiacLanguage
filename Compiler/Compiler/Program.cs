...
namespace Compiler {
    ...
    public class ZodiacGrammar : Grammar {
        ...
        public ZodiacGrammar() {
            ...
            this.MarkTransient(type_declaration, statement, expression, bin_operator, expression);
            ...
            member_variable.Rule = ToTerm("var") + identifier + semi;
            member_function.Rule = (ToTerm("family") | Empty) + function_definition;
